...
//
// A remark by Joe and Kuo shows how to extend the algorithm from the original maximum spatial dimension of 40// up to a maximum spatial dimension of 1111. The FORTRAN90 and C++ versions of this program have been updated//  in this way. In particular, the extra data in the C++ version of the program was kindly formatted and supp// lied by Steffan Berridge.
//
